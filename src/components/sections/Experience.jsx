  ...
  return (
    <motion.article
      ...
      style={{
        ...
        border: "1px solid",
        borderColor: hovered ? `${accent}48` : "rgba(255,255,255,0.07)",
        boxShadow: hovered
          ? `0 24px 64px rgba(0,0,0,0.45), 0 0 0 1px ${accent}22, 0 0 48px ${accent}12`
      ...
      <div style={{ padding: "24px 24px 20px", display: "flex", flexDirection: "column", gap: "16px", flex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
          <div style={{
            ...
            background: `linear-gradient(145deg,${accent}22,${accent}0A)`,
        ...
        <div>
          <h3 style={{
            ...
            lineHeight: 1.25, letterSpacing: "-0.01em", marginBottom: "5px",
          }}>
            {exp.title}
          </h3>
        ...
        {/* Summary */}
        <p style={{ fontSize: "13px", color: "#718096", lineHeight: 1.65 }}>
          {exp.summary}
        </p>
              ...
              <ul style={{ display: "flex", flexDirection: "column", gap: "8px", paddingBottom: "4px" }}>
                {exp.details.map((d, i) => (
                  ...
                  >
                    <CheckCircle2
                      size={13}
                      style={{ color: accent, flexShrink: 0, marginTop: "3px" }}
                      aria-hidden="true"
                    />
                    {d}
                  </motion.li>
        ...
        <button
          ...
          style={{
            ...
            background: expanded ? `${accent}18` : `${accent}0C`,
            border: `1px solid ${accent}30`,
          ...
          onMouseEnter={e => {
            ...
            e.currentTarget.style.boxShadow  = `0 0 12px ${accent}28`
          }}
          onMouseLeave={e => {
            e.currentTarget.style.background = expanded ? `${accent}18` : `${accent}0C`
            e.currentTarget.style.boxShadow  = "none"
          }}
        >
          {expanded
            ? <><ChevronUp size={13} aria-hidden="true" /> View Less</>
            : <><ChevronDown size={13} aria-hidden="true" /> View More</>
          }
        </button>
      </div>
    </motion.article>
