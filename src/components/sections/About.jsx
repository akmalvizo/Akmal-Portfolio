...
/* ─── KPI stat card ──────────────────────────────────────────── */
function StatCard({ value, label, index, accent }) {
  const [hov, setHov] = useState(false)
  const reduced = useReducedMotion()
  const accents = [T.cyan, T.purple, T.green, T.amber]
  const color   = accent || accents[index % 4]
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 16px 48px rgba(0,0,0,0.4), 0 0 32px ${color}15`
    ...
    >
      ...
      <p style={{ fontSize: "11px", fontWeight: 600, color: T.muted,
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: `1px solid ${hov ? color + "45" : T.border}`,
        boxShadow: hov
          ? `0 20px 56px rgba(0,0,0,0.45), 0 0 40px ${color}12`
    ...
    >
      ...
      <div style={{
        ...
        <motion.div
          animate={hov && !reduced ? { rotate: [0,-8,8,0] } : {}}
      ...
      <div style={{ flex: 1 }}>
        <p style={{
          fontSize: "13px", fontWeight: 700, color: T.head,
  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: hov ? `0 0 12px ${T.cyan}60` : "none",
        transition: "box-shadow 0.28s",
      }} aria-hidden="true" />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <p style={{ fontSize: "14px", fontWeight: 800,
                           color: T.head, letterSpacing: "-0.01em" }}>
                {edu.degree}
              </p>
              <p style={{ fontSize: "12px", color: T.body, marginTop: "2px",
                           display: "flex", alignItems: "center", gap: "5px" }}>
                <MapPin size={10} style={{ color: T.cyan }} aria-hidden="true" />
                {edu.institution}
              </p>
            </div>
          </div>
  ...
  return (
    <div style={{ textAlign: "center", marginBottom: "32px" }}>
      ...
      <h2 style={{
        ...
        About{" "}
        <GradText from={T.cyan} to={T.purple}>Me</GradText>
      </h2>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse,rgba(124,111,234,0.04) 0%,transparent 65%)",
      }} aria-hidden="true" />
      ...
      >
        <style>{`
          @media(min-width:1024px){
            .about-main-grid { grid-template-columns: 1.1fr 1fr !important; gap: 56px !important; }
          }
        `}</style>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <motion.h3
            ...
            style={{
              ...
              color: T.head, lineHeight: 1.25, letterSpacing: "-0.02em",
            }}
          >
          ...
          >
            {[
              ...
              <span key={text} style={{
                ...
                fontSize: "13px", color: T.body, fontWeight: 500,
              }}>
